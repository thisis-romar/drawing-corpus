# EMBLEM-NLP-RSPEC-001 — Summary Table

*Section 11.1 — one row per drawing type. Generated 2026-06-13 from `drawing-corpus.json`.*

| ID | Drawing Type | Group | Confidence | Tier | License | Retrieved | Human Review | Paywalled |
|----|--------------|-------|-----------|------|---------|-----------|--------------|-----------|
...
| B03 | Bus Topology Diagram | B | MEDIUM | 2 | Creative Commons Attribution 4.0 | committed | no | no |
| B04 | Memory Topology Drawing | B | MEDIUM | 1 | JEDEC reference | url-only | no | no |
| B05 | Thermal Management Drawing | B | LOW | 2 | Intel reference use only | url-only | YES | no |
| B06 | EMI / Shielding Drawing | B | MEDIUM | 2 | Public domain | url-only | YES | no |
| B07 | Thermal / Airflow Diagram | B | LOW | 2 | Intel reference use only | url-only | YES | no |
